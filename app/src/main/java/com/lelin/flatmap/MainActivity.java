...
import com.lelin.flatmap.network.ServiceGenerator;
        ...
        return ServiceGenerator.getRequestApi().getComments(post.getId())
                .map(new Function<List<Comment>, Post>() {
                    ...
                    public Post apply(List<Comment> comments) throws Exception {
                        ...
                        Thread.sleep(delay);
                        Log.e(TAG, "apply: sleeping thread: "+Thread.currentThread().getName()+" for "
        ...
        return ServiceGenerator.getRequestApi()
                ...
                .flatMap(new Function<List<Post>, ObservableSource<Post>>() {
                    ...
                    public ObservableSource<Post> apply(final List<Post> posts) throws Exception {
                        ...
                        Log.e(TAG, "apply: post size "+posts.size() );
